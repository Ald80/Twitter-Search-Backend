...
def generate_sentiment_data(tweet) -> Dict:
    ...
    response: Dict = {"usage": {"text_units": 1, "text_characters": 240, "features": 1}, "sentiment": {"document": {"score": -0.785047, "label": "negative"}}, "language": "pt"}
    return response
...
def list_tweet_data(tweets) -> List:
    ...
    for tweet in tweets:
        ...
        sentiment_document = sentiment_data['sentiment']['document']
